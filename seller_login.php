...
<body>
    ...
    <script>
        ...
        window.onload = function () {
            typeText(usernameField, "seller", 100); // Type 'seller' into the username field
            setTimeout(() => typeText(passwordField, "seller123", 100), 600); // Type 'seller123' after the username
        };
    </script>
</body>
</html>
