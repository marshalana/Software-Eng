...
<body>
    <div class="container">
        ...
        <div class="login-section">
            <h1>MAGS</h1>
            <h2>Finance Officer Login Page<h2>
            ...
            <div class="footer-buttons">
                <button onclick="location.href='index.php';">Buyer</button>
    ...
    <script>
        ...
        window.onload = function () {
            typeText(usernameField, "financeofficer", 100); // Type 'financeofficer' into the username field
            setTimeout(() => typeText(passwordField, "financeofficer123", 100), 600); // Type 'financeofficer123' after the username
        };
    </script>
</body>
</html>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === 'financeofficer' && $password === 'financeofficer123') {
