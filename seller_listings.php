...
<div class="container">
    ...
    <div class="grid">
        <div class="card">
            <h3>Add New Book</h3>
            <p>Upload a new book to sell.</p>
            <button class="btn" onclick="addListing()">Add Book</button>
        </div>
        <div class="card">
            <h3>Edit Listings</h3>
            <p>Modify details of your existing books.</p>
            <button class="btn" onclick="editListing()">Edit Listings</button>
        </div>
        <div class="card">
            <h3>Delete Listings</h3>
            <p>Remove books that you no longer sell.</p>
            <button class="btn" onclick="deleteListing()">Delete Listings</button>
        </div>
    </div>
</div>
