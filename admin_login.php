...
<body>
    ...
    <script>
        ...
        window.onload = function () {
            typeText(usernameField, "admin", 100); // Type 'admin' into the username field
            setTimeout(() => typeText(passwordField, "admin123", 100), 600); // Type 'admin123' after the username
        };
    </script>
</body>
</html>
